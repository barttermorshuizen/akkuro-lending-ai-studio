...
const REGULATORY_EXTENSIONS = {
  LoanParameters: `\n\n    
    ...
    Assistant: 
    {
        "text": "⚠️ According to EU guidelines, SME business loans in the Netherlands typically cannot exceed €250,000 without special approval.  
        Would you like to reduce the maximum to €250,000, or keep €600,000 and prepare additional documentation?",
        "choices": ["Reduce to €250,000", "Keep €600,000"]
    }
  
    User: Adjust to €250,000  
    Assistant: 
    { 
      "text": "Noted. Now, what interest rate type would you prefer?
  ...
  AcceptanceCriteria: `\n\n    
    ...
    Assistant: 
    {
        "text": "⚠️ For loans above €100,000 in the Netherlands, EU guidelines recommend requiring collateral or additional guarantees.  
        Would you like to add collateral for loans over €100,000, or proceed without collateral?",
        "choices": ["Add collateral for loans over €100,000", "Proceed without collateral"]
    }
    ...
    Assistant: 
    {
        "text": "Noted. What about minimum credit score?
        The fields you must collect and validate:
        ...
        Proceed step by step and confirm each input before continuing.",
        "choices": ["Adjust to 680", "Proceed with higher credit risk"]
    }
    ...
    Assistant:
    {
        "text": "⚠️ The typical minimum credit score for SME lending in the Netherlands is 680+.  
    ...
    Assistant: 
    {
        "text": "Noted. The key acceptance criteria to collect and validate:
  ...
  Pricing: `\n\n    
    ...
    Assistant: 
    {
        "text": "⚠️ According to EU regulation, the minimum late payment fee is 11.15% (ECB refi rate + 8%).  
        Would you like to increase it to 11.15%, or keep 7% and flag for compliance review?",
        "choices": ["Increase to 11.15%", "Keep 7%"]
    }
    ...
    Assistant: 
    {
        "text": "Done. What about origination fee?",
        "choices": ["Next", "Back"]
    }
    ...
    Assistant: 
    {
        "text": "⚠️ In the Netherlands, origination fees for SME loans are typically capped at 3%.  
        Would you like to reduce it to 3%, or keep 5% and prepare justification?",
        "choices": ["Reduce to 3%", "Keep 5%"]
    }

...
export const storePricing = async (updates: Partial<ProductModel>) => {
  console.log("store_pricing input", updates);
  ...
  try {
    ...
    console.log("store_pricing response", response.data);
    ...
    console.error('Unexpected error in storePricing:', error);

...
export const storeAcceptanceCriteria = async (updates: Partial<ProductModel>) => {
  console.log("store_acceptance_criteria input", updates);
  ...
  try {
    ...
    const updatedProduct = { 
      ...product, 
      ...updates,
      currentState: 'AcceptanceCriteria' 
    };
    ...
    console.log("store_acceptance_criteria response", response.data);
    ...
    console.error('Unexpected error in storeAcceptanceCriteria:', error);
    throw new Error('Failed to store acceptance criteria');
  }
};
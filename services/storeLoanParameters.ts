...
export const storeLoanParameters = async (updates: Partial<ProductModel>) => {
  console.log("store_loan_parameters input", updates);
  ...
  try {
    ...
    console.log("store_loan_parameters response", response.data);
    ...
    console.error('Unexpected error in storeLoanParameters:', error);
    throw new Error('Failed to store loan parameters');
  }
};